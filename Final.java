	 ...
	 //--------------------------------------------------------------------------------------------------------------
	        ...
	        //take screenshot after submit
	         TakesScreenshot t5=(TakesScreenshot) w;
	  		 ...
	  		 Files.copy(src5, new File("D:\\Screenshot\\submit.png"));
	  		 w.navigate().back();
	  		 Thread.sleep(3000);
	  		 w.navigate().back();
	         ...
	         w.switchTo().window(parent_window5);
	  		 ...
	  		 Files.copy(src6, new File("D:\\Screenshot\\vegan.png"));
	...
	//--------------------------------------------------------------------------------------------------------------------------------------------------  			
	  			...
	  			//Tc02
	  					...
	  					w.findElement(By.xpath("//*[@id=\"main-nav\"]/div[1]/div/ul[1]/li[1]/a")).click();
	  				     ...
	  				     js.executeScript("window.scrollTo(0,800)", "scroll");
	  			...
	  			//TC05	     
	  				     ...
	  				     w.findElement(By.xpath("//*[@id=\"contact_form\"]/div[4]/input")).click();
	  				       ...
	  				       Files.copy(src7, new File ("D:\\Screenshot\\fil.png"));
	  				       
	  				       w.findElement(By.xpath("//*[@id=\"main-nav\"]/div[1]/div/ul[1]/li[1]/a")).click();
	  				       
	  				       
	  					   js.executeScript("window.scrollTo(0,1800)", "scroll");
